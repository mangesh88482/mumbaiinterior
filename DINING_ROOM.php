	...
	<div style="background:#353b55; padding:70px;">
		<div class="container">
			...
			<center id="texthover" style="font-size:40px; color:white; font-weight:bold;">
				Dining <span style="color:#098899;">Room.</span>
				<br>
	   ...
	   <div class="container">
		<div class="row">
			...
			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine1.jpg" width="100%">
			</div>

			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine2.jpg" width="100%">
			</div>
			
				<br><br>
			
			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine3.jpg" width="100%">
			</div>
			
				<br><br>

			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine4.jpg" width="100%">
			</div>
			
				<br><br>
			
			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine5.jpg" width="100%">
			</div>
			
			<div class="col-md-4" style="padding:40px;">
				<img src="image/dining_room/dine6.jpg" width="100%">
			</div>
